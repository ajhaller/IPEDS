...
school_preferences(
  ...
  select(
    `Institution`, `Institution Size`, `Region`, 
    `Alternative Credit`, `Student Diversity`, 
    `% of Students Recieved Aid`, `Type of Institution`
  )
```
...
```{r, warning=FALSE}
school_preferences() %>%
  ggplot(aes(x = `Staff Diversity`, y = `Student Diversity`)) +
  geom_point() +
  geom_smooth(method = "lm", formula = "y ~ sqrt(x)") +
  labs(
    title = "Student Diversity vs. Staff Diversity",
    y = "Student Diversity (%)",
    x = "Staff Diversity (%)"
  )
```
...
school_preferences(region = "New England") %>%
  ...
  labs(
    title = "Student Diversity vs. Staff Diversity in New England Institutions",
    y = "Student Diversity (%)",
    x = "Staff Diversity (%)"
  )
```
...
school_preferences(region = "New England") %>%
  ...
  ggplot(
    aes(
      x = `Staff Diversity`, y = `Student Diversity`, 
      color = factor(`Institution Size`)
      )
    ) +
  geom_point() +
  ...
  labs(
    title = "Student Diversity vs. Staff Diversity in New England Institutions by Size",
    y = "Student Diversity (%)",
    x = "Staff Diversity (%)",
    color = "Institution Size"
  )
```
